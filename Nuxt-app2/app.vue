<template>
	<main>
		<h1>Zoznam ľudí</h1>
		<section class="list">
			<section v-for="person of persons" v-bind:key="person" v-bind:class="{ 'card-container': true, card: true, adult: personAge(person.birthday) >= 18 }">
				<PersonalCard v-bind:person="person"></PersonalCard>
			</section>
		</section>
	</main>
</template>
